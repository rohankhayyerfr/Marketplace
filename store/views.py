...
from .models import Product, ProductVariant, SellerProfile, Category
...
def dashboard(request):
    ...
    return render(request, 'dashboard/index.html', {'products': products, 'sellerprofile': sellerprofile})
